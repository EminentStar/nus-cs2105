...
First, use dig to lookup your favourite domain name a few times, note down the query time.  This step uses your default local DNS server (either by your ISP or by the university, depending on where you run the experiments).
